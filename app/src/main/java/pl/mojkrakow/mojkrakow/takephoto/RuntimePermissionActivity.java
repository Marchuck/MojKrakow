package pl.mojkrakow.mojkrakow.takephoto;
...
public class RuntimePermissionActivity extends AppCompatActivity {
    ...
    @DebugLog
    void sendResult(final boolean isPermissionGranted) {

//        if (Utils.isAtLeastLollipop()) {
//            Intent intent = new Intent(this, GeolocationActivity.class);
//
//            ActivityOptionsCompat options = ActivityOptionsCompat.
//                    makeSceneTransitionAnimation(this, (View) findViewById(R.runId.photo), "fragment_profile_image");
