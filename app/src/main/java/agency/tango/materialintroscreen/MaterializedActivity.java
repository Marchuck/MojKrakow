...
public abstract class MaterializedActivity extends AppCompatActivity {
...
//        }
        ...
        permissionNotGrantedClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                nextButtonTranslationWrapper.error();
                MaterializedActivity.this.showPermissionsNotGrantedError();
            }
        };
...
//                        SharedPreferencesManager.setCurrentIntroItemUsed(position);
...
//        int lastItem = SharedPreferencesManager.getSharedPrefs().getInt(SharedConstants.LAST_SEEN_ITEM, 0);
        return 0;
    }

    @DebugLog
    public void switchToLastSeenItem() {
        switchTo(getLastSeenItem());
    }
